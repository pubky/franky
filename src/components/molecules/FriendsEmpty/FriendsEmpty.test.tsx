...
describe('FriendsEmpty', () => {
  ...
  it('renders description', () => {
    render(<FriendsEmpty />);
    expect(
      screen.getByText(/Follow someone, and if they follow you back, you'll become friends!/i),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Start following Pubky users, you never know who might follow you back!/i),
    ).toBeInTheDocument();
  });
  ...
  it('renders background image', () => {
    ...
    expect(image).toHaveAttribute('alt', 'Friends - Empty state');
  });
});

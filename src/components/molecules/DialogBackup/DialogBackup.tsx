      ...
      <Atoms.DialogContent className="sm:max-w-xl gap-0">
        ...
        <Atoms.Container className="h-full pr-4 overflow-y-auto">
          <Atoms.Container className="gap-4">
            ...
            <Atoms.Container className="w-full flex flex-row gap-3">
              <Atoms.Card className="w-full p-6 bg-card rounded-lg flex flex-col gap-6">
                ...
                <Image src="/images/note.png" alt="Note" width={112} height={112} className="w-28 h-28" />
              ...
              <Atoms.Card className="w-full p-6 bg-card rounded-lg flex flex-col gap-6">
                ...
                <Image src="/images/folder.png" alt="Folder" width={112} height={112} className="w-28 h-28" />
                <Atoms.Button>Continue</Atoms.Button>
              </Atoms.Card>
              <Atoms.Card className="w-full p-6 bg-card rounded-lg flex flex-col gap-6">
                <Atoms.Typography size="md" className="text-base font-bold text-card-foreground leading-none">
                ...
                <Image src="/images/keyring.png" alt="Keys" width={112} height={112} className="w-28 h-28" />
                <Atoms.Button>Continue</Atoms.Button>
              </Atoms.Card>
            </Atoms.Container>
          </Atoms.Container>

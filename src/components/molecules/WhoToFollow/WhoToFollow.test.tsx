...
vi.mock('@/atoms', () => ({
  ...
  SidebarButton: ({
    ...
    <button
      ...
      className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-full border border-border px-4 py-2 transition-colors hover:bg-secondary/80"
      {...props}
    >

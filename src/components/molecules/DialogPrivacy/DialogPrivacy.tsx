      ...
      <Atoms.DialogContent className="sm:max-w-xl">
        ...
        <Atoms.Container className="h-[320px] pr-4 overflow-y-auto">
          <Atoms.Container className="flex-col gap-4">
            ...
            <Atoms.Typography className={baseCSS}>Updates & Contact:</Atoms.Typography>
            <Atoms.List>
            ...
            <Atoms.Typography className={baseCSS}>
              ...
              about you: identifiers; commercial information; internet or similar network activity; visual information;
              and inferences drawn from other personal information. We collect these categories of information from you
              in order to provide our services to you, to run our business, to communicate with you, and as required by
            ...
            <Atoms.Typography className={baseCSS}>
              For a description of your rights under the CCPA, and instructions on how to exercise your rights, please
            ...
            <Atoms.Typography className={baseCSS}>
              ...
              reasonably necessary to: (i) provide our products and services or administer our relationship with a
              consumer; (ii) protect our business, employees, organization, and others; (iii) fulfill our legal and
              regulatory obligations; and (iv) investigate and address issues which may include safety concerns,
            ...
            <Atoms.List>
              <li>
                Contact Information. For example, we may collect your telephone number and email address. We may also
                collect your mobile phone number.
              </li>
              <li>
                Information You Submit. We may collect information when you send us a message through the “Contact Us”
                page or similar features on our Platform. It also includes collecting information that you publicly post
                via the Platform.
              </li>
              <li>
                Payment Information. We, through our vendors, may collect and store your payment information. This may
                include wallet addresses or keys.
              </li>
              <li>
                Account Information. Certain portions of the Platform allow you to create a user account. In connection
                with that account, we collect your public key. We will also collect any information you use to complete
                your profile. This may include your name, a short bio, and a picture that you upload.
              </li>
              <li>
                Device Information. For example, we may collect information about the type of device you use to access
                our Platform. We may also collect your device identifier, IP address or mobile operating system. We may
                also infer your general location based on your IP address.
              </li>
              <li>
            ...
            <Atoms.List>
              <li>
                Directly From You. For example, when you create a profile, post on the Platform, or submit an inquiry to
                us.
              </li>
              <li>
                Passively. For example, when you visit and navigate our Platform on any device. We may also collect
                information about users over time and across different websites and devices when you use the Platform.
              </li>
              <li>
                From Third Parties. We may receive information about you from other sources. For example, this may
                include receiving information from our business partners, including analytics vendors.
              </li>
              <li>
                By Combining Information. We may combine information that we collect offline with information we collect
                through our Platform. We may also combine information we collect about you from the different devices
            ...
            <Atoms.List>
              <li>
                To Run and Improve Our Platform and Business. We may use your information to operate and improve the
                Platform. We may also use your information to provide you with information about our business.
              </li>
              <li>To Respond to Your Requests or Questions. This may include responding to your feedback.</li>
              <li>
                To Communicate With You. We may communicate with you about your account or our relationship. We may also
                contact you about this Policy or our Platform terms and conditions.
              </li>
              <li>
                For Security Purposes. This could include protecting our company and consumers who use our products and
                services. It may also include protecting our Platform.
              </li>
            ...
            <Atoms.List>
              <li>
                Cookies: You can adjust your browser to control cookies to require your affirmative acceptance for new
                cookies, automatically reject cookies and/or delete or disable existing cookies. How you do so depends
                on the type of cookie and the browser that you are using. For more information on how to control browser
                cookies,{' '}
                <Atoms.Link
                  target="_blank"
              ...
              <li>
                Email Tools: You can also change your email settings to block the automatic download of images in email
                messages, as such images may contain technologies that help us understand how you interact with the
                message.
              </li>
              <li>
            ...
            <Atoms.List>
              <li>
                ...
                features are not all uniform. We do not currently respond to those signals. If you block cookies,
                certain features on our sites may not work. If you block or reject cookies, not all of the tracking
                described here will stop.
              </li>
            ...
            <Atoms.List>
              <li>
                Notice.This means that you can request that we disclose what personal information we have collected
                about you, including the categories of personal information, the categories of sources from which the
                personal information is collected, the business or commercial purpose for collecting, selling, or
                sharing personal information, the categories of third parties to whom we have disclosed personal
                information, and the specific pieces of personal information we have collected about you.
              </li>
              <li>
                Access. This enables you to receive a copy of the personal data we hold about you and to check that we
                are lawfully processing it.
              </li>
              <li>
                Deletion. This means that you can request that we delete personal information about you which we have
                collected from you. Note, however, that we may not always be able to comply with your request of erasure
                for specific legal reasons which will be notified to you, if applicable, at the time of your request.
              </li>
              <li>
                Correction. This means that you can request that we correct inaccurate personal information that we
                maintain about you.
              </li>
              <li>
                Object to Specific Processing. This means that you may object to processing of your personal information
                ...
                impacts on your fundamental rights and freedoms. In some cases, we may demonstrate that we have
                compelling legitimate grounds to process your information which override your rights and freedoms.
              </li>
              <li>
                Withdraw Consent. Where we are relying on consent to process your personal information, you may withdraw
                that consent at any time. However, this will not affect the lawfulness of any processing carried out
              ...
              <li>
                Limit the Use or Disclosure of Sensitive Personal Information. The California Consumer Privacy Act
                (“CCPA”) provides a right for consumers to request that business limit the use or disclosure of their
                “sensitive” personal information. In our normal business operations, we do not process “sensitive
                personal information” as that term is defined under CCPA. Please do not submit this information to us.
              </li>
              <li>
                Opt-Out of the Sale or Sharing of Personal Information. You may have the right to opt out of the “sale”
                or sharing of personal information with third parties for cross-contextual marketing purposes. We do not
                knowingly “sell” or “share” any personal information, including any personal information relating to
                consumers under the age of 16, as we understand those terms to be defined under applicable law.
              </li>
            </Atoms.List>
            ...
            <Atoms.Typography className={baseCSS}>
              Agents that you have authorized to act on your behalf may also submit requests as instructed below. The
              agent Should you wish to report a complaint or if you feel that we have not addressed your concern in a
            ...
            <Atoms.Typography className={baseCSS}>
              Information we maintain may be stored in or outside of the United States. If you live outside of the
              United States, you understand and agree that we may transfer your personal information to the United
              States. This Platform is subject to the laws of the United States, which may not provide the same level of
              protections as those in your own country. Personal information processed and stored in another country,
              including the United States, may be subject to disclosure or access requests by the governments, courts or
              law enforcement or regulatory agencies in that country according to its laws. By using our Platform or by
              providing us with personal information, you consent to any such transfer of information outside of your
              country.
            </Atoms.Typography>

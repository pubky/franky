...
describe('Badge', () => {
  it('renders with default props', () => {
    ...
    expect(badge).toHaveClass('inline-flex', 'items-center', 'justify-center', 'rounded-md', 'border', 'px-2', 'py-0.5', 'text-xs', 'font-medium');
  ...
  it('forwards additional props', () => {
    render(<Badge data-testid="badge" data-custom="test">Test</Badge>);

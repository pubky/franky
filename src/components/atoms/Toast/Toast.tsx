...
>(({ className, variant = 'default', ...props }, ref) => {
  ...
  return <ToastPrimitives.Root ref={ref} className={cn(...baseStyles, className)} {...props} />;
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn('text-popover-foreground text-base font-bold leading-6', className)}
    {...props}
  />
));

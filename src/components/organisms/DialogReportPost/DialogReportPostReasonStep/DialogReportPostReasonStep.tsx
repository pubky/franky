        ...
        <Atoms.Container className="rounded-lg border border-dashed border-border p-4" overrideDefaults>
          <Atoms.Container className="gap-4">
            ...
            <Atoms.Textarea
              ...
              className="min-h-20 resize-none border-none bg-transparent p-0 text-base font-medium break-words text-secondary-foreground shadow-none focus-visible:ring-0 focus-visible:ring-offset-0"
              value={reason}

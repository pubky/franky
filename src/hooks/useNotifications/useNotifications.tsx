...
export function useNotifications(): UseNotificationsResult {
   ...
   */
  useEffect(() => {
    if (notifications.length === 0 || mutedUserIdSet.size === 0) return;
    setNotifications((prev) => filterMutedNotifications(prev));
  }, [mutedUserIdSet, filterMutedNotifications, notifications.length]);

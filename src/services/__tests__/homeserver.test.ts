...
import { HomeserverService } from '../homeserver/index';
import { Keypair, PublicKey } from '@synonymdev/pubky';
import { HomeserverErrorType } from '../../lib/error';
...
describe('HomeserverService', () => {
  ...
  describe('Authentication', () => {
    it('should signup successfully', async () => {
      ...
      (mockClient.signup as Mock).mockResolvedValue({
        pubky: () => ({ z32: () => 'test-key' }),
    ...
    it('should handle signup errors', async () => {
      ...
      const mockClient = service.getClient() as unknown as MockClient;
      (mockClient.signup as Mock).mockRejectedValue(error);
    ...
    it('should logout successfully', async () => {
      ...
      (mockClient.signout as Mock).mockResolvedValue(undefined);
    ...
    it('should handle logout errors', async () => {
      ...
      (mockClient.signout as Mock).mockRejectedValue(error);
  ...
  describe('Data Operations', () => {
    ...
    it('should fetch data (GET)', async () => {
      ...
      (mockClient.fetch as Mock).mockResolvedValue(mockResponse);
    ...
    it('should handle fetch errors', async () => {
      ...
      const mockClient = service.getClient() as unknown as MockClient;
      (mockClient.fetch as Mock).mockRejectedValue(error);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty response data', async () => {
      ...
      (mockClient.fetch as Mock).mockResolvedValue(new Response('', { status: 200 }));
    ...
    it('should handle different HTTP status codes', async () => {
      ...
      (mockClient.fetch as Mock).mockResolvedValue(new Response('Not Found', { status: 404 }));
    ...
    it('should preserve credentials option', async () => {
      ...
      (mockClient.fetch as Mock).mockResolvedValue(new Response('OK', { status: 200 }));
  ...
  describe('Error Handling', () => {
    it('should throw INVALID_HOMESERVER_KEY error for invalid homeserver key', async () => {
      ...
      const mockClient = service.getClient() as unknown as MockClient;
      mockClient.signup.mockRejectedValue(new Error('invalid public key'));
    ...
    it('should throw INVALID_PUBLIC_KEY error for invalid public key during logout', async () => {
      ...
      mockClient.signout.mockRejectedValue(new Error('invalid public key'));

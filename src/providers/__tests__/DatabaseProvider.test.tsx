...
import { DatabaseProvider, DatabaseContext, type DatabaseContextType } from '../DatabaseProvider';
import { db } from '@/database';
import { DatabaseErrorType, createDatabaseError } from '@/lib/error';
...
describe('DatabaseProvider', () => {
  ...
  it('should initialize database successfully', async () => {
    vi.mocked(db.initialize).mockResolvedValueOnce();
  ...
  it('should handle database initialization error', async () => {
    ...
    vi.mocked(db.initialize).mockRejectedValueOnce(error);
  ...
  it('should handle retry initialization', async () => {
    ...
    const initializeMock = vi.mocked(db.initialize);
    initializeMock
  ...
  it('should handle unexpected errors', async () => {
    ...
    vi.mocked(db.initialize).mockRejectedValueOnce(unexpectedError);

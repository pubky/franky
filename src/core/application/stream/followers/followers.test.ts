...
describe('FollowersStreamApplication', () => {
  ...
  describe('getOrFetchStreamSlice', () => {
    it('should return users from cache when available (no skip)', async () => {
      ...
      const result = await Core.FollowersStreamApplication.getOrFetchStreamSlice({
        streamId,
    ...
    it('should fetch from Nexus when cache is empty', async () => {
      ...
      // Mock Nexus service
      vi.spyOn(Core.NexusFollowersStreamService, 'fetch').mockResolvedValue(mockNexusUsers);
    ...
    it('should return empty array when no more users available', async () => {
      ...
      vi.spyOn(Core.NexusFollowersStreamService, 'fetch').mockResolvedValue([]);
  ...
  describe('fetchMissingUsersFromNexus', () => {
    ...
    it('should fetch and persist users when userBatch exists', async () => {
      ...
      const persistUsersSpy = vi
        .spyOn(Core.LocalStreamFollowersService, 'persistUsers')
    ...
    it('should handle when userBatch is null/undefined', async () => {
      ...
      const persistUsersSpy = vi.spyOn(Core.LocalStreamFollowersService, 'persistUsers');

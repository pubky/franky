...
import { TagStreamTypes } from '@/core/models/stream/tag/tagStream.types';
...
class AppDatabase extends Dexie {
  ...
  tag_streams!: Dexie.Table<Core.TagCollectionModelSchema<TagStreamTypes>>;
  constructor() {
    ...
    try {
      this.version(Config.DB_VERSION).stores({
        ...
        tag_streams: tagCollectionTableSchema,
      });
    } catch (error) {
